...
public class JPAUtil {
    ...
    public static final String SELECT_TALENTREVIEWSCORE_BY_REVIEWER = "select * from public.talent_review_score where reviewer_id=? order by employee_id";
    ...
    public static final String SELECT_MAX_REVIEW_PERIOD = "select review_period from public.review_period where id=(select max(id) from public.review_period)";
